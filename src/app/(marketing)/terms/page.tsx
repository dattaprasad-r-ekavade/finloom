import { Box, Typography, Stack, Divider, Alert } from '@mui/material';
import { ContentPage } from '@/components/ui';

export default function TermsAndConditions() {
  return (
    <ContentPage title="Terms and Conditions" meta="Preview draft · September 23, 2026">
      ...
      <Stack spacing={3}>
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>1. Acceptance of Terms</Typography>
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>2. Description of Services</Typography>
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>3. Eligibility</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>4. User Accounts</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>5. Challenge Plans and Fees</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>6. Trading Rules and Risk Limits</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>7. Payments</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>8. Intellectual Property</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>9. Limitation of Liability</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>10. Privacy</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>11. Governing Law and Dispute Resolution</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>12. Modifications to Terms</Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Box>
          <Typography variant="h6" component="h2" sx={{ mb: 1 }}>13. Contact Information</Typography>
          <Typography variant="body2" color="text.secondary">
