      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        {!hasCompletedKyc && (
          <Alert
            ...
            sx={{
              borderRadius: 3,
              border: (theme) => `1px solid ${(theme.vars || theme).palette.warning.light}`,
              mb: 4,
            }}
            action={
              <Button
        ...
        {statusError && (
          <Alert
            ...
            sx={{
              borderRadius: 3,
              border: (theme) => `1px solid ${(theme.vars || theme).palette.error.light}`,
              mb: 4,
            }}
          >
            {statusError}
                ...
                <AreaChart data={metricsSeries.cumulative}>
                  <defs>
                    <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor={chartColors.brand} stopOpacity={0.8} />
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={metricsSeries.trades}>
                  ...
                  <YAxis stroke={chartColors.axis} />
                  <Tooltip />
                  <Bar dataKey="trades" fill={chartColors.series[1]} />
                </BarChart>
              </ResponsiveContainer>
            </Paper>
          </Box>
