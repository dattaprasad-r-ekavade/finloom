          ...
          <CardContent sx={{ p: { xs: 4, md: 6 } }}>
            <Stack spacing={4}>
              ...
              {copyFeedback && (
                <Alert
                  severity="info"
                  sx={{ borderRadius: 2, border: (theme) => `1px solid ${(theme.vars || theme).palette.info.light}` }}
                >
                  {copyFeedback}
                </Alert>
              )}
                      ...
                      <Stack spacing={0.5}>
                        ...
                        <Typography
                          ...
                          sx={{
                            fontWeight: 600,
                            color: (theme) =>
                              isActive ? (theme.vars || theme).palette.success.main : (theme.vars || theme).palette.warning.main,
                          }}
                        >
