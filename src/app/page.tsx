        ...
        <svg viewBox="0 0 600 220" preserveAspectRatio="none" className="replay-chart__svg">
          <defs>
            <linearGradient id="replayArea" x1="0" x2="0" y1="0" y2="1">
              <stop offset="0%" stopColor="#8ed5bd" stopOpacity="0.26" />
              <stop offset="100%" stopColor="#8ed5bd" stopOpacity="0" />
            </linearGradient>
          </defs>
          ...
          <path d="M0 171 C30 160 39 178 67 157 S103 142 122 155 S155 166 176 126 S208 112 229 130 S261 149 281 116 S315 94 340 106 S366 123 388 94 S416 77 435 90 S464 78 483 60 S520 78 540 48 S575 41 600 28" fill="none" stroke="#9ed9c3" strokeWidth="3" vectorEffect="non-scaling-stroke" />
          <circle cx="600" cy="28" r="5" fill="#fff" stroke="#9ed9c3" strokeWidth="3" vectorEffect="non-scaling-stroke" />
        </svg>
          ...
          <Container maxWidth="xl" className="home-hero__container">
            <Box className="home-hero__copy">
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} className="home-hero__actions">
                <Button className="button-primary" onClick={() => router.push('/trader/signup')} endIcon={<ArrowForwardRounded />}>
                  Get started
                </Button>
                <Button className="button-secondary" onClick={() => document.getElementById('pathway')?.scrollIntoView({ behavior: 'smooth' })}>
                  See how it works
                </Button>
              </Stack>
        ...
        <Box component="section" id="pathway" className="pathway-section">
          <Container maxWidth="xl">
            ...
            <Box className="pathway-grid">
              {steps.map((step) => (
                <Card className="pathway-card" key={step.number} elevation={0}>
        ...
        <Box component="section" className="certificate-section">
          <Container maxWidth="xl" className="certificate-section__inner">
            ...
            <Box className="certificate-section__detail">
              ...
              <Button className="certificate-section__link" onClick={() => router.push('/about')} endIcon={<ArrowForwardRounded />}>Read about the pathway</Button>
            </Box>
          </Container>
        </Box>
      </Box>
